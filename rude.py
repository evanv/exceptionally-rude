...
INSULTS = [
    "Have you done this before? Write code I mean.",
...
class Insult(Exception):
    def __init__(self, exception):
        msg = '{} {}'.format(exception.message, choice(INSULTS))
        super(Insult, self).__init__(msg)
 
 
def add_insult_to_injury(exception):
    raise Insult(exception)
 
 
#figure out a way to run this on all errors.... 

if __name__ == '__main__':
    try:
        raise Exception('Regular exception')
    except Exception as e:
        add_insult_to_injury(e)